...
<template>
    <button :class="buttonClasses" :disabled="props.disabled"
        class="flex items-center transition ease-in-out relative gap-x-2 justify-center rounded-lg border opacity-70 hover:opacity-100 dark:hover:bg-midnight-600  border-gradient text-gradient disabled:border-transparent disabled:opacity-50 disabled:hover:opacity-50 disabled:text-gray-400 disabled:bg-gray-200 dark:disabled:bg-midnight-600 dark:disabled:text-midnight-400 disabled:cursor-not-allowed">
        <svg v-if="props.icon === 'left'" class="fill-gradient" xmlns="http://www.w3.org/2000/svg" :width="iconSize"
        ...
        <svg v-if="props.icon === 'right'" class="fill-gradient" xmlns="http://www.w3.org/2000/svg" :width="iconSize"
            :height="iconSize" viewBox="0 0 24 24">
            <path
                d="M7.45284 2.71266C7.8276 1.76244 9.1724 1.76245 9.54716 2.71267L10.7085 5.65732C10.8229 5.94743 11.0526 6.17707 11.3427 6.29148L14.2873 7.45284C15.2376 7.8276 15.2376 9.1724 14.2873 9.54716L11.3427 10.7085C11.0526 10.8229 10.8229 11.0526 10.7085 11.3427L9.54716 14.2873C9.1724 15.2376 7.8276 15.2376 7.45284 14.2873L6.29148 11.3427C6.17707 11.0526 5.94743 10.8229 5.65732 10.7085L2.71266 9.54716C1.76244 9.1724 1.76245 7.8276 2.71267 7.45284L5.65732 6.29148C5.94743 6.17707 6.17707 5.94743 6.29148 5.65732L7.45284 2.71266Z" />
            <path
